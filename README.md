...
* Criar diferentes tipos de tarefas: tarefas simples, tarefas com prazo e tarefas recorrentes. (Uso de Classes)
* Adicionar subtarefas a uma tarefa principal.  (Conceitos de Herança)
